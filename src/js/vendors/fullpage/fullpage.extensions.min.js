...
!(function(e, t, n, o, r) {
	...
	function Gn(e, t) {
		return (t = 1 < arguments.length ? t : sn)
	...
	function wo(e, t, n) {
		...
		(n = void 0 === n ? {} : n),
			'function' == typeof an.CustomEvent
				...
				: (o = sn.createEvent('CustomEvent')).initCustomEvent(
						t,
						!0,
						!0,
						n,
		...
		function(e, g) {
			...
			if (!Un(s, pn)) {
				...
				var p,
					...
					I = {
						...
						touchstart:
							'ontouchstart' in an ? 'touchstart' : R.down,
					},
					z = !1,
				...
				e
					...
					: (se(!1),
					  (function() {
							if (l || u) {
								g.autoScrolling &&
									(m.removeEventListener(I.touchmove, Be, {
										passive: !1,
									}),
									m.removeEventListener(I.touchmove, ze, {
										passive: !1,
			...
			function Oe(e, t) {
				t || null != Gn(yn)[0] || lo(e, gn),
					...
					g.paddingBottom &&
						Jn(e, { 'padding-bottom': g.paddingBottom }),
			...
			function at(e) {
				if (
					...
					B ||
						(F = F.replace('extensions/', '').replace(
							'Extension',
							'',
						)),
					(U.innerHTML = F),
