		...
		u.ConfigCallbacks.registerAction(
			...
			i.extend(u.FilterGroup.prototype, {
				init: function(u, e) {
					...
					(t.dom.el = u),
						(this.name =
							t.dom.el.getAttribute('data-filter-group') || ''),
						t.cacheDom(),
				...
				handleClick: function(u) {
					var e = this,
						...
						E = '';
					l &&
						(((o = e.mixer.config.selectors.control) &&
							!l.matches(o)) ||
							(u.stopPropagation(),
							t.lastClicked || (t.lastClicked = l),
							('function' ==
								typeof t.config.callbacks.onMixClick &&
								...
								(l.matches('[data-filter]')
									? ((E = l.getAttribute('data-filter')),
									  (e.activeToggles = []),
									  (e.activeSelectors = e.activeFilters = [
											E,
									  ]))
								...
								e.updateControls(),
								'change' ===
									e.mixer.config.multifilter.parseOn &&
					...
					if (!(['text', 'search', 'email'].indexOf(t.type) < 0)) {
						...
						clearTimeout(e.keyupTimeout),
							(e.keyupTimeout = setTimeout(function() {
								...
								.mixer.config.multifilter.keyupThrottleDuration));
					}
				},
				handleFormEvent: function(e) {
					...
					e.target === i.form &&
						...
						i.totalHandled === i.totalBound &&
							...
							('submit' !== e.type &&
								'change' !==
									t.mixer.config.multifilter.parseOn) ||
				...
				getSingleValue: function(u) {
					...
					if (u.type.match(/text|search|email/g)) {
						...
						if (
							u.value.length <
							e.mixer.config.multifilter.minSearchLength
						)
							return void (e.activeSelectors = e.activeFilters = e.activeToggles = [
								'',
							]);
						for (
							o = u.value.toLowerCase().trim(), n = 0;
							(i = t[n]);
							n++
						)
							o = o.replace(i[1], i[0]);
				...
				getMultipleValues: function(u) {
					...
					for (
						l = e.dom.el.querySelectorAll(i), o = 0;
						(r = l[o]);
						o++
					)
				...
				updateControls: function(u) {
					...
					for (
						...
						(l = Boolean(t.getAttribute('data-toggle'))
							? 'toggle'
							: 'filter'),
							e.updateControl(t, l);
				},
				...
				updateUi: function() {
					var u = this,
						...
						o = -1;
					for (
						e.length && u.updateControls(e, !0), o = 0;
						(l = t[o]);
						o++
					)
						switch (
							((r = i.indexOf(l.value) > -1),
			...
			u.Mixer.registerAction('afterCacheDom', 'multifilter', function() {
				...
				if (e.config.multifilter.enable) {
					switch (e.config.controls.scope) {
						...
						default:
							throw new Error(
								u.messages.ERROR_CONFIG_INVALID_CONTROLS_SCOPE,
							);
					}
			...
			u.Mixer.registerAction(
				'beforeInitControls',
				'multifilter',
				function() {
					var u = this;
					u.config.multifilter.enable &&
						(u.config.controls.live = !0);
				},
			),
			u.Mixer.registerAction(
				'afterSanitizeConfig',
			...
			u.Mixer.extend({
				indexFilterGroups: function() {
					...
					for (r = 0; (i = e.dom.filterGroups[r]); r++)
						if (
							...
							if (
								'undefined' != typeof e.filterGroupsHash[t.name]
							)
								throw new Error(
				...
				buildSelectorFromPaths: function(u) {
					...
					if (!u.length) return '';
					if (
						('or' === e.config.multifilter.logicBetweenGroups &&
							(l = ', '),
						u.length > 1)
					) {
				...
				parseFilterGroups: function() {
					...
					return (
						...
						'function' ==
							typeof (r =
								u.config.callbacks.onParseFilterGroups) &&
							(l = r(l)),
			...
			u.Facade.registerAction('afterConstruct', 'multifilter', function(
				u,
			) {
				(this.parseFilterGroups = u.parseFilterGroups.bind(u)),
					(this.setFilterGroupSelectors = u.setFilterGroupSelectors.bind(
						u,
					)),
					(this.getFilterGroupSelectors = u.getFilterGroupSelectors.bind(
						u,
					));
			});
	};
